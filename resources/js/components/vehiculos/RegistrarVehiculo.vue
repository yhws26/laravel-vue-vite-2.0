...
const registrarVehiculo = () => {
    ...
    axios.post('api/add_vehiculo', formData)
        .then((response) => {
            form.value.marca = '',
                form.value.modelo = '',
                form.value.placa = '',
            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item bg-primary" style="border-radius: 7px">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                ...
                                                <div class="input-group-append">
                                                    <router-link to="/tipos" class="btn btn-success">Registrar Tipos</router-link>
                                                </div>
                                            </div>
                                            </div>
                                        </div>
